        ...
        <div class="col-form-label" id="printableArea">
            ...
            <div class="invoice">
                <div class="card-body">
                                ...
                                <div class="col-md-6">
                                    <address>
                                        <div class="my-2">
                                            ...
                                            {{ \App\Models\Invoice::invoiceNumberFormat($invoice->invoice_id) }}<br>
                                        </div>
                                        <div class="my-2">
                                            <strong>{{ __('Invoice Date') }} :</strong>
                                            {{ company_date_formate($invoice->issue_date) }}<br>
                                        </div>
                                        <div class="my-2">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="invoice-total d-flex align-items-end flex-column justify-content-end"
