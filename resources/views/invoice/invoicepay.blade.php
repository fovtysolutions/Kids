                                    ...
                                    @if (!empty($inspectionRequest->inspector_name) && !empty($inspectionRequest->inspector_email))
                                        <div class="col">
                                            <p class="font-style">
                                                ...
                                                {{ !empty($invoice->customer_id) ? \Workdo\VehicleInspectionManagement\Entities\InspectionRequest::inspectionRequestIdFormat($invoice->customer_id, $invoice->created_by, $invoice->workspace) : '' }}<br>
                                            </p>
                                            <p class="font-style">
                                                <strong>{{ __('Billed To') }} :</strong><br>
                                            ...
                                            <tfoot>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-end">
                                                        ...
                                                        @if ($invoice->invoice_module == 'childcare')
                                                        {{ currency_format_with_sym($commonSubtotal,$invoice->created_by, $invoice->workspace) }}
                                                        @else
