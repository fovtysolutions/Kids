...
@if ($user->is_disable == 1 || Auth::user()->type == 'super admin')
    @if (Auth::user()->type == 'super admin')
        <div class="action-btn me-2">
            <a data-url="{{ route('company.info', $user->id) }}" class="btn btn-sm d-inline-flex align-items-center bg-primary"
    ...
    @permission('user delete')
        <div class="action-btn">
            ...
            @method('DELETE')
            <a href="#" class="btn btn-sm  align-items-center bs-pass-para show_confirm bg-danger" data-bs-toggle="tooltip"
