                    ...
                    <div class="card-body">
                        ...
                        <div class="row d-flex align-items-center justify-content-end">
                            ...
                            <div class="col-auto float-end mt-4 d-flex">
                                ...
                                <a href="{{ route('users.index') }}" id="clearfilter" class="btn btn-sm btn-danger" data-bs-toggle="tooltip" title="{{ __('Reset') }}"
                ...
                <div class="card">
                    <div class="card-header border-0 pb-0">
                        <div class="d-flex align-items-center">
                            <span class="badge bg-primary p-2 px-3">{{ $user->type }}</span>
                        </div>
                    ...
                    <div class="card-body  text-center">
                        <img src="{{ check_file($user->avatar) ? get_file($user->avatar) : get_file('uploads/users-avatar/avatar.png') }}"
                            alt="user-image" class="img-fluid rounded border-2 border border-primary" width="120px" style="
                            height: 120px">
        ...
        @auth('web')
            @permission('user create')
                <div class="col-md-3 All">
                    <a href="#" class="btn-addnew-project border-primary" style="padding: 90px 10px;" data-ajax-popup="true" data-size="md"
