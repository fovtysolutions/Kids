    ...
    <div class="d-flex">
        @if (module_is_active('ProductService') && (module_is_active('Account') || module_is_active('Taskly')))
            ...
            @permission('proposal manage')
                ...
                <a href="{{ route('proposal.stats.view') }}"  data-bs-toggle="tooltip" data-bs-original-title="{{__('Quick Stats')}}" class="btn btn-sm btn-primary btn-icon me-2">
                ...
                <div class="card-body">
                    ...
                    <div class="row d-flex align-items-center justify-content-end">
                        ...
                        <div class="col-auto float-end mt-4 d-flex">
                            ...
                            <a href="{{ route('proposal.grid.view') }}" class="btn btn-sm btn-danger" data-bs-toggle="tooltip"
