                                        ...
                                        <table class="table mb-0 ">
                                            ...
                                            <tfoot>
                                                <tr>
                                                    ...
                                                    <td><b>{{ currency_format_with_sym($totalRate, $proposal->created_by, $proposal->workspace) }}</b>
                                                    </td>
                                                    <td><b>{{ currency_format_with_sym($totalDiscount, $proposal->created_by, $proposal->workspace) }}</b>
                                                    </td>
                                                    <td><b>{{ currency_format_with_sym($totalTaxPrice, $proposal->created_by, $proposal->workspace) }}</b>
                                                    </td>
                                                    <td></td>
                                                    <td></td>
                                                </tr>
