...
<head>
    ...
    <title>@if (trim($__env->yieldContent('template_title')))@yield('template_title') | @endif {{ __('Workdo Dash SaaS') }}</title>
...
<div class="master">
    ...
    <div class="box">
        <div class="header">
            <h1 class="header__title">@yield('title') | <a style="color:red;" href="https://bit.ly/3Uzh8xZ" target="_blank">Web Community</a></h1>
        </div>
        <ul class="step">
