                            ...
                            <div class="invoice">
                                <div class="invoice-print">
                                    ...
                                    <div class="row">
                                        ...
                                        @if(!empty($company_settings['shipping_display']) && company_setting('shipping_display')=='on')
                                            <div class="col">
                                                <small>
                                    ...
                                    <div class="row mt-3">
                                        <div class="col">
                                            <small>
                                                ...
                                                @if($purchase->status == 0)
                                                    <span class="badge bg-secondary p-2 px-3">{{ __(App\Models\Purchase::$statues[$purchase->status]) }}</span>
                                                    ...
                                                    <td>
                                                        @if(!empty($payment->add_receipt))
                                                            <div class="action-btn me-2">
                                                                <a href="{{ get_file($payment->add_receipt)}}" download="" class="mx-3 btn btn-sm align-items-center bg-primary" data-bs-toggle="tooltip" title="{{__('Download')}}" target="_blank" >
                                                                    <i class="ti ti-download text-white" ></i>
                                                                </a>
                                                            </div>
                                                            <div class="action-btn">
                                                                <a href="{{ get_file($payment->add_receipt)}}" class="mx-3 btn btn-sm align-items-center bg-secondary" data-bs-toggle="tooltip" title="{{__('Show')}}" target="_blank" >
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @permission('purchase debitnote edit')
                                                            <div class="action-btn me-2">
                                                                <a data-url="{{ route('purchases.edit.debit.note',[$debitNote->purchase,$debitNote->id]) }}" data-ajax-popup="true" data-title="{{__('Edit Debit Note')}}" href="#" class="mx-3 btn btn-sm align-items-center bg-info" data-bs-toggle="tooltip" data-original-title="{{__('Edit')}}">
