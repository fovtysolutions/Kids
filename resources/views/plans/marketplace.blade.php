...
@push('scripts')
                    ...
                    success: function(data)
                    {
                        if (data != '' ) {
                            if (data.is_success == true) {
                                ...
                                $('.planpricetext').html('<span class="original-price">' + formatCurrency(data.price,'{{ $admin_settings }}')+ '</span> / ' + '<span class="final_price">'+finalPrice + '</span>');
    ...
    <script>
        ...
        function SwitchChange()
        {
            ...
            $(".user-price").text('( {{ __("Per User")}} '+ formatCurrency(userprice,'{{ $admin_settings }}')+')');
            $(".userpricetext").text(formatCurrency(userpricetext,'{{ $admin_settings }}'));
