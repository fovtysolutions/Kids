                            ...
                            <div class="card-body p-3">
                                <div class="d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="form-check">
                                        ...
                                        <input class="form-check-input modules" name="modules[]" value="{{$module->name}}" id="{{ $module->name }}" {{in_array($module->name,explode(',',$plan->modules)) == true ? 'checked' : ''  }} type="checkbox">
                                    </div>
                                </div>
                            </div>
                        </div>
