...
@push('scripts')
    <script>
        $(document).ready(function() {
            ...
            $(".total").text(formatCurrency(planprice,'{{ $admin_settings }}'));
        });
                    ...
                    success: function(data)
                    {
                        if (data != '' ) {
                            if (data.is_success == true) {
                                    ...
                                    $('.total').html('<span class="original-price">' + formatCurrency(planprice,'{{ $admin_settings }}')+ '</span> / ' + '<span class="">'+finalPrice + '</span>');
