            ...
            <div class="card">
                <div class="card-body p-3">
                    <div class="d-flex align-items-center justify-content-between">
                        ...
                        <div class="ms-3 mb-3 mt-3">
                            <h6>{{ __('Order Amount') }} : <span
                                    class="text-dark">{{ super_currency_format_with_sym($user['total_orders_price']) }}</span>
                            </h6>
                        </div>
                    </div>
                </div>
            ...
            <div class="card">
                <div class="card-body p-3">
                    <div class="d-flex align-items-center justify-content-between">
                        ...
                        <div class="number-icon ms-3 mb-3 mt-3">
                            <h3>{{ $user->total_plans }}</h3>
                        </div> 
                        <div class="ms-3 mb-3 mt-3">
                            <h6>{{ __('Popular Plan') }} : <span
                                    class="text-primary">{{ !empty($user->popular_plan) ? $user->popular_plan->name : '' }}</span>
                            </h6>
                        </div>
                    </div>
                </div>
