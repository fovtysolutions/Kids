...
@section('page-action')
    <div class="d-flex">
        ...
        @permission('revenue create')
            <a class="btn btn-sm btn-primary" data-ajax-popup="true" data-size="lg" data-title="{{ __('Create New Revenue') }}"
                        ...
                        <div class="col-xl-10">
                            <div class="row">
                                <div class="col-3">
                                    ...
                                    {{ Form::text('date', isset($_GET['date']) ? $_GET['date'] : date('Y-m-d'), ['class' => 'month-btn form-control flatpickr-to-input', 'placeholder' => 'Select Date']) }}
                                </div>
