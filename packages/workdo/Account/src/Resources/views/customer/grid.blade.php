...
@section('content')
    <div class="row">
                            ...
                            <div class="btn-group card-option">
                                ...
                                @if($customer->is_disable == 0)
                                    <div class="dropdown-menu dropdown-menu-end">
                                        @if (Laratrust::hasPermission('customer show') || Laratrust::hasPermission('customer edit') || Laratrust::hasPermission('customer delete'))
        ...
        @endforeach
        <div class="col-md-3 ">
            <a href="#" data-url="{{ route('customer.create') }}" class="btn-addnew-project border border-primary " data-ajax-popup="true"
