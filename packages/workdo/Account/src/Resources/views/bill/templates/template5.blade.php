...
<head>
    ...
    <title>{{ \Workdo\Account\Entities\Bill::billNumberFormat($bill->bill_id, $bill->created_by, $bill->workspace) }} |
                            ...
                            <table class="no-space">
                                <tbody>
                                    <tr>
                                        <td>{{ __('Number: ') }}</td>
                                        <td class="text-right">
                                            {{ Workdo\Account\Entities\Bill::billNumberFormat($bill->bill_id, $bill->created_by, $bill->workspace) }}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>{{ __('Issue Date:') }}</td>
