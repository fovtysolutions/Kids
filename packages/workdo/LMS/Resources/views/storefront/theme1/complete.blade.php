...
<head>
    ...
    <title>{{__('Completed')}} - {{($store->tagline) ?  $store->tagline : config('APP_NAME', 'WorkDo')}}</title>
    ...
    <link rel="stylesheet" href="{{asset('Modules/LMS/Resources/assets/css/site.css')}}" id="stylesheet">
    <link rel="stylesheet" href="{{asset('Modules/LMS/Resources/assets/css/custom.css')}}" id="stylesheet')}}">
    @if(env('SITE_RTL')=='on')
            ...
            <section class="mh-100vh d-flex align-items-center" data-offset-top="#header-main">
                <div class="bg-absolute-cover bg-size--contain d-flex align-items-center zindex0">
                    <figure class="w-100 success_img">
                        <img alt="Image placeholder" src="{{asset('Modules/LMS/Resources/assets/img/bg-2.svg')}}" class="svg-inject success_img">
                    </figure>
                </div>
                        ...
                        <div class="col-lg-7">
                            <div class="text-center pt-10">
                                ...
                                <div class="row justify-content-center mb-5">
                                    <div class="col-md-5">
                                        <img alt="Image placeholder" src="{{asset('Modules/LMS/Resources/assets/img/celebration.png')}}" class="svg-inject img-fluid">
                                    </div>
                                </div>
...
<script src="{{asset('Modules/LMS/Resources/assets/js/site.core.js')}}"></script>
<!-- notify -->
<script type="text/javascript" src="{{ asset('Modules/LMS/Resources/assets/js/lmscustom.js')}}"></script>
...
<!-- Site JS -->
<script src="{{asset('Modules/LMS/Resources/assets/js/site.js')}}"></script>
<!-- Demo JS - remove it when starting your project -->
<script src="{{asset('Modules/LMS/Resources/assets/js/demo.js')}}"></script>
