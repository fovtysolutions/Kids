...
<div class="modal-body">
    <div class="row">
        <div class="form-group col-12">
            ...
            {{ Form::text('name', null, array('class' => 'form-control','required'=>'required','placeholder' => __('Enter Label Name'),'maxlength' => '30')) }}
        </div>
        <div class="form-group col-12">
        ...
        <div class="form-group col-12">
            {{ Form::label('color', __('Color'),['class'=>'col-form-label']) }} <x-required></x-required>
