                                                ...
                                                <span class="float-end">
                                                    @permission('labels edit')
                                                        <div class="action-btn me-2">
                                                            <a data-size="md" data-url="{{ URL::to('labels/'.$label->id.'/edit') }}" data-ajax-popup="true" data-title="{{__('Edit Labels')}}" class="mx-3 btn btn-sm align-items-center bg-info" data-bs-toggle="tooltip" data-bs-placement="top" title="{{__('Edit Labels')}}" ><i class="ti ti-pencil text-white"></i></a>
                                                        </div>
                                                    @endpermission
