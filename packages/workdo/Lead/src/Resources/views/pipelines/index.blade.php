                                        ...
                                        <td class="Action">
                                            ...
                                            @permission('pipeline edit')
                                                <div class="action-btn me-2 mt-1">
                                                    <a data-size="md" data-url="{{ URL::to('pipelines/'.$pipeline->id.'/edit') }}" data-ajax-popup="true" data-title="{{__('Edit Pipeline')}}" class="mx-3 btn btn-sm align-items-center bg-info" data-bs-toggle="tooltip" data-bs-placement="top" title="{{__('Edit Pipeline')}}" ><i class="ti ti-pencil text-white"></i></a>
                                                </div>
                                                @endpermission
