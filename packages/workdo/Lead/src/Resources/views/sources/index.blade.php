                                    ...
                                    <td class="Active ">
                                        ...
                                        @permission('source edit')
                                                <div class="action-btn me-2">
                                                    <a data-size="md" data-url="{{ URL::to('sources/'.$source->id.'/edit') }}" data-ajax-popup="true" data-title="{{__('Edit Source')}}" class="mx-3 btn btn-sm align-items-center bg-info" data-bs-toggle="tooltip" data-bs-placement="top" title="{{__('Edit Source')}}" ><i class="ti ti-pencil text-white"></i></a>
                                                </div>
                                            @endpermission
