                                                ...
                                                @if ($labels)
                                                    <div class="card-header border-0 pb-3 position-relative pt-3 ps-3">
                                                        @foreach ($labels as $label)
                                                            <div class="badge bg-{{ $label->color }} p-2 px-3 mb-1">
                                                                {{ $label->name }}</div>
                                                        @endforeach
                                                @else
                                                    ...
                                                    <ul class="list-inline mb-0">
                                                        <li class="list-inline-item d-inline-flex align-items-center"
                                                            data-bs-toggle="tooltip" data-bs-original-title="Task"><i
                                                                class="f-16 text-primary ti ti-list"></i>
                                                    ...
                                                    <ul class="list-inline mb-0">
                                                        <li class="list-inline-item d-inline-flex align-items-center"
                                                            data-bs-toggle="tooltip" data-bs-original-title="Product"><i
                                                                class="f-16 text-primary ti ti-shopping-cart"></i>{{ count($lead->products()) }}
                                                        </li>
                                                        <li class="list-inline-item d-inline-flex align-items-center"
                                                            data-bs-toggle="tooltip" data-bs-original-title="Source"><i
                                                                class="f-16 text-primary ti ti-social"></i>{{ count($lead->sources()) }}
                                                        </li>
                                                    </ul>
