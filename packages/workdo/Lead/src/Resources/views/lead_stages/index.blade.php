                                        ...
                                        <td class="d-flex justify-content-end">
                                            @permission('leadstages edit')
                                                <div class="action-btn me-2">
                                                    <a data-size="md" data-url="{{ route('lead-stages.edit',$lead_stages->id) }}" data-ajax-popup="true" data-title="{{__('Edit Lead Stages')}}" class="mx-3 btn btn-sm align-items-center bg-info" data-bs-toggle="tooltip" data-bs-placement="top" title="{{__('Edit Lead Stages')}}" ><i class="ti ti-pencil text-white"></i></a>
                                                </div>
                                            @endpermission
