            ...
            <div class="card">
                <div class="card-body">
                    <div class="row mt-2">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-12 justify-content-end d-flex">
                            <h4 class="invoice-number">{{ \workdo\Pos\Entities\Pos::posNumberFormat($pos->pos_id) }}</h4>
                        </div>
                        <div class="col-12">
                            <hr>
                        </div>
                            ...
                            <div class="d-flex align-items-center justify-content-end">
                                <div class="me-4">
                                    <small>
                                        ...
                                        {{company_date_formate($pos->pos_date)}}<br><br>
                                    </small>
                                </div>
                            </div>
                        </div>
