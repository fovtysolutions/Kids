                    ...
                    <div class="tab-content" id="pills-tabContent">
                        <div class="tab-pane fade show active" id="details-tab" role="tabpanel"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            {{ Form::text('sku', !empty($productService->sku)?$productService->sku:'', ['class' => 'form-control','required' => 'required']) }}
                            ...
                            <div class="form-group col-md-12">
                                ...
                                {!! Form::textarea('description', !empty($productService->description)?$productService->description:'', ['class' => 'form-control', 'rows' => '2']) !!}
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="form-icon-user">
                                            {{ Form::number('sale_price', !empty($productService->sale_price)?$productService->sale_price:'', ['class' => 'form-control', 'step' => '0.01','required' => 'required']) }}
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
