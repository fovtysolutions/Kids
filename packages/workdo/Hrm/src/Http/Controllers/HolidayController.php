...
class HolidayController extends Controller
{
    ...
    public function store(Request $request)
    {
        if (Auth::user()->isAbleTo('holiday create')) {
            ...
            return redirect()->route('holiday.index')->with('success', 'The holiday has been created successfully.');
        } else {
            return redirect()->back()->with('error', __('Permission denied.'));
        }
    }
    ...
    public function update(Request $request, Holiday $holiday)
    {
        if (\Auth::user()->isAbleTo('holiday edit')) {
            ...
            return redirect()->route('holiday.index')->with('success', 'The holiday details are updated successfully.');
        } else {
            return redirect()->back()->with('error', __('Permission denied.'));
        }
    }
    ...
    public function destroy(Holiday $holiday)
    {
        if (Auth::user()->isAbleTo('holiday delete')) {
            ...
            return redirect()->route('holiday.index')->with('success', 'The Holiday has been deleted.');
        } else {
            return redirect()->back()->with('error', __('Permission denied.'));
        }
    }
