...
<div>
    @permission('paysliptype create')
        <a  class="btn btn-sm btn-primary" data-ajax-popup="true" data-size="md" data-title="{{ __('Create New Payslip Type') }}" data-url="{{route('payslip-type.create')}}" data-bs-toggle="tooltip"  data-bs-original-title="{{ __('Create') }}">
                                        ...
                                        <span>
                                            ...
                                            <div class="action-btn  me-2">
                                                <a  class="mx-3 btn bg-info btn-sm  align-items-center"
                                                    data-url="{{ route('payslip-type.edit', $paysliptype->id) }}"
                                            ...
                                            <div class="action-btn">
                                                {{Form::open(array('route'=>array('payslip-type.destroy', $paysliptype->id),'class' => 'm-0'))}}
                                                @method('DELETE')
                                                    <a 
