                    ...
                    <div class="col-md-4">
                        <div class="form-group col">
                            <div class=" form-switch p-0">
                                ...
                                <div class=" float-end">
                                    <input type="checkbox" class="form-check-input" id="ip_restrict" name="ip_restrict"
                            ...
                            <div class="col-md-4">
                                <div class="card-header card-body">
                                    <div class="form-group">
                                        ...
                                        {{ Form::select('job_template', Workdo\Recruitment\Entities\JobCandidate::templateData()['templates'], !empty($settings['job_template']) ? $settings['job_template'] : null, ['class' => 'form-control', 'required' => 'required']) }}
