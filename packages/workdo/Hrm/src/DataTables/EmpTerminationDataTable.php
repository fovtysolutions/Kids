    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        $dataTable->editColumn('termination_type', function (Termination $terminations) {
            ...
            ->editColumn('description', function (Termination $terminations) {
                ...
                $html = '<div class="action-btn ms-2">
                            <a class="mx-3 btn bg-warning btn-sm align-items-center" data-url="' . $url . '" data-ajax-popup="true"
                            data-bs-toggle="tooltip" title="' . __('Description') . '" data-title="' . __('Description') . '">
