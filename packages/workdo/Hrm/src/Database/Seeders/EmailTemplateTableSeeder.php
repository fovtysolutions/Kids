    ...
    public function run()
    {
        ...
        $defaultTemplate = [
            ...
            'Leave Status' => [
                ...
                'variables' => '{"App Name": "app_name","App Url": "app_url","Leave Status Name": "leave_status_name","Leave Status": "leave_status","Leave Reason": "leave_reason","Leave Start Date": "leave_start_date","Leave End Date": "leave_end_date","Total Leave Days": "total_leave_days"}',
                'lang' => [
