@if ($currentWorkspace && $bug)
    <div class="modal-body">
        <div class="p-2">
            ...
            <textarea class="form-control form-control-light mb-2" rows="5" required>{{ $bug->description }}</textarea>
                            ...
                            <li class="row media border-bottom mb-3">
                                ...
                                <div class="col-auto text-end mt-2">
                                    @auth('web')
                                        ...
                                        <a href="#" class="action-btn btn-danger btn btn-sm d-inline-flex align-items-center delete-comment"
