...
@if($project)
    @push('css')
        <link rel="stylesheet" href="{{ asset('packages/workdo/Taskly/src/Resources/assets/css/frappe-gantt.css')}}" />
    @endpush
    @push('scripts')
        @php
        ...
        <script src="{{ asset('packages/workdo/Taskly/src/Resources/assets/js/frappe-gantt.js')}}"></script>
