                                        ...
                                        <td class="Action">
                                            <span>
                                                <div class="action-btn">
                                                    <a href="{{ route('projects.show',$vendor_project->project_id) }}" data-bs-toggle="tooltip" title="{{__('Details')}}"  data-title="{{__('Project Details')}}" class="mx-3 btn btn-sm d-inline-flex align-items-center text-white bg-warning">
                                                        <i class="ti ti-eye"></i>
                                                    </a>
                                                </div>
                                            </span>
